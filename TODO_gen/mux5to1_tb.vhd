...
constant dw : positive := 3;
-- testing signals

signal u_dut, v_dut, w_dut, x_dut, y_dut, m_dut : std_logic_vector ( dw - 1 downto 0);
signal sel : std_logic_vector (2 downto 0) ;
signal m_ref: std_logic_vector ( dw - 1  downto 0); -- reference (expected) output
